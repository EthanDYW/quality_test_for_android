...
public final class ItemPhotoBinding implements ViewBinding {
  ...
  private ItemPhotoBinding(@NonNull MaterialCardView rootView,
      @NonNull ImageView checkmarkImageView, @NonNull MaterialCardView photoCard,
  ...
  public static ItemPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPhotoBinding((MaterialCardView) rootView, checkmarkImageView, photoCard,
          photoImageView);
    }
